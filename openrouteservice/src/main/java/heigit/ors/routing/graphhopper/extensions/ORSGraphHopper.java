...
public class ORSGraphHopper extends GraphHopper {
    ...
    public GHResponse directRoute(GHRequest request) {
        LineString directRouteGeometry = constructDirectRouteGeometry(request);
        PathWrapper directRoutePathWrapper = constructDirectRoutePathWrapper(directRouteGeometry);
    ...
    private PathWrapper constructDirectRoutePathWrapper(LineString lineString) {
    ...
    private LineString constructDirectRouteGeometry(GHRequest request){
